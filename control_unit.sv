...
module control_unit(
 ...
 output rv32_pkg::aluop_t alu_ctrl
  ...
  alu_ctrl = ALU_ADD;
    ...
    alu_ctrl = ALU_SUB;
    else if (func3 == 3'b000) alu_ctrl = ALU_ADD;
    ...
    7'b0000011: begin alu_src=1; mem_read=1; mem_to_reg=1; reg_write=1; alu_ctrl = ALU_ADD; end // LW
    7'b0100011: begin alu_src=1; mem_write=1; alu_ctrl = ALU_ADD; end // SW
    7'b1100011: begin branch=1;   alu_ctrl = ALU_SUB; end // BEQ
    7'b1101111: begin jal=1; reg_write=1; end // JAL
    7'b1100111: begin jalr=1; alu_src=1; reg_write=1;  alu_ctrl  = ALU_ADD; end // JALR
    default: ;
    endcase
    end
endmodule
